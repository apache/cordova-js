...
InAppBrowser.prototype = {
    ...
    insertCSS: function(injectDetails, cb) {
        ...
        if (injectDetails.code && injectDetails.file) {
            ...
            script = "(function(d) { var c = d.createElement('style'); c.innerText = " + sourceString + "; d.body.appendChild(c); })(document)";
            exec(cb, null, "InAppBrowser", "injectScriptCode", [script]);
        } else if (injectDetails.file) {
            sourceString = JSON.stringify(injectDetails.file);
            script = "(function(d) { var c = d.createElement('link'); c.rel='stylesheet', c.type='text/css'; c.href = " + sourceString + "; d.head.appendChild(c); })(document)";
            exec(cb, null, "InAppBrowser", "injectScriptCode", [script]);
        } else {
            throw new Error('insertCSS requires exactly one of code or file to be specified');
        }
