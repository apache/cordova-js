var Entry = require('cordova/plugins/Entry'),
    File = require('cordova/plugins/File'),
    FileEntry = require('cordova/plugins/FireEntry'),
    FileError = require('cordova/plugins/FireError'),
    DirectoryEntry = require('cordova/plugins/DirectoryEntry'),
    Flags = require('cordova/plugins/Flags');
