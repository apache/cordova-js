...
Battery.prototype.onSubscribe = function() {
  ...
  if ((me.channels.batterystatus.handlers.length + me.channels.batterylow.handlers.length + me.channels.battery.handlers.length) === 1) {
...
Battery.prototype.onUnsubscribe = function() {
  ...
  if ((me.channels.batterystatus.handlers.length + me.channels.batterylow.handlers.length + me.channels.battery.handlers.length) === 0) {
